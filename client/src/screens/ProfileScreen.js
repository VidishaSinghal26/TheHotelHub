   ...
   //const rooms;
    useEffect(() => {
        const fetchData = async () => {
          try {
            setloading(true)
            const rooms = await (await axios.post('https://the-hotel-hub-theta.vercel.app/api/booking/getbookingsbyuserid', {userid : user._id})).data;
      ...
      async function cancelBooking(bookingid , roomid){
        try{
          setloading(true)
          const result = await (await axios.post('https://the-hotel-hub-theta.vercel.app/api/booking/cancelbooking' , {bookingid , roomid})).data
          console.log(result);
          setloading(false )
