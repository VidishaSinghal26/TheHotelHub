...
export function Bookings(){
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            setloading(true)
            const rooms = await (await axios.post('https://the-hotel-hub-theta.vercel.app/api/booking/getallbookings')).data;
 ...
 export function Users(){
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            setloading(true)
            const data = (await axios.get('https://the-hotel-hub-theta.vercel.app/api/users/getallusers')).data
            console.log(data);
            setusers(data);
            setloading(false)
 ...
 export function Addroom(){
  ...
  async function addroom(){
    ...
    try {
      ...
      setloading(true)
      const result = await(await axios.post('https://the-hotel-hub-theta.vercel.app/api/rooms/addroom' , newroom)).data
      console.log(result)
      setloading(false)
